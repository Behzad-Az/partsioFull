...
const populate = function populate() {
  const instruments = [
    { id: 'fXt6U3UwM0o', title: 'Item 1', kind: 'Pressure Transmitter', photo_links: ['photo1.1', 'photo1.2'], company_name: 'Shell', company_id: ['comp1', 'comp2'], search_text: 'hello how are you 1', expired: false, created_at: new Date(2012, 1, 2, 3, 4, 6).toJSON() },
